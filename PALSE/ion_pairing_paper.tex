...
For \ce{PIm+Br-} we measure $\gamma_c = 800\%$ and thus $E_c \approx 65 k_\mathrm{B}T$ per head-to-body bond or \SI{160}{\kilo\joule\per\mol}. This value is much higher than the $E_i\approx\SI{5}{\kilo\joule\per\mol}$ typical of ionic bonds in water\cite{Schneider1992}, even when adding up the two bonds of the bivalent phosphonate head. This implies that the electrostatic bond is reinforced by other supramolecular interactions, probably hydrophobic interactions between the surrounding uncharged monomers of both chains and $\pi$-stacking of the imidazolium\cite{Rehm2010}.
