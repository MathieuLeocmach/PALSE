...
We find that the number $n$ of chains between cross-link point goes from 1 in \ce{PPyr+I-} and \ce{PPy+Br-} to 780 in \ce{PIm+Br-}, following the \textit{a priori} ranking of charge dissociation, see Table~\ref{tab:results}. This is coherent with a higher probability of attaching two or more heads on a highly dissociated body, i.e. a large cross-linking ratio.
...
\begin{loglogaxis}[
	...
	\addplot[only marks] coordinates {(1.090233298, 72.59) (6.98656403, 3141.79) (1.000001279, 69.17) (9.589224893, 7876.54)};
	\addplot[no marks, domain=1:10] {70*x^2};
\end{loglogaxis}
\end{tikzpicture}
\end{center}
