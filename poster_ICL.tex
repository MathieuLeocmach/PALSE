...
\def\affiliation#1{\Large \color{Accent2}\textit{#1}\smallskip}
\def\Subhead#1{\noindent{\large\color{Accent1}\textsc{#1}}}
\def\Title#1{\noindent{\veryHuge\color{ilmorange}\raggedright\textsf{\textbf{#1}}}}
...
\rule[-.3\baselineskip]{0pt}{5cm}\hfill\pgfuseimage{cnrs-logo}\hspace*{\mydim}\pgfuseimage{ucbl-logo}\hspace*{\mydim}
...
\includegraphics[height=4cm]{presentation/ICL}\hspace*{0.5cm}
...
}}\hspace{0.1\paperwidth}\texttt{\color{Accent1}\Large mathieu.leocmach@univ-lyon1.fr}\\
