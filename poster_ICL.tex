...
\input{fig_poster/flowcurves.pgf}
...
%	
%	\medskip
%	\hfill\begin{minipage}{3\TPHorizModule}
%	\sisetup{
...
\begin{textblock}{3}(8,17.5)
	...
	\hfill\input{fig_poster/microenvironment.pgf}\hfill
...
\begin{textblock}{3}(12,10)
	...
	\input{fig_poster/phase_diag.pgf}
...
\begin{textblock}{3}(0,18.5)
	\Subhead{Diffusion}
	\begin{itemize}
		\item of the polyelectrolyte (made fluorescent)
		\item in a porous matrix (agar or casein)
		\item under mechanical stimulation (yield stress)
	\end{itemize}
	\tikzsetnextfilename{tensioconf}%
	\input{fig_poster/tensioconf.pgf}
...
\begin{textblock}{3}(4,18.5)
	...
	\end{itemize}
	\includegraphics[width=\textwidth]{presentation/tensiometre_eclate.png}
...
\begin{textblock}{3}(12,19.5)
	...
	\input{fig_poster/fluo_Amel.pgf}
	\begin{itemize}
